INCLUDE "fortISSimO/include/hardware.inc" ; Bread & butter: check.
INCLUDE "fortISSimO/include/hUGE.inc" ; Get the note constants.
...
PeriodTable:
	INCLUDE "fortISSimO/include/hUGE_note_table.inc"
